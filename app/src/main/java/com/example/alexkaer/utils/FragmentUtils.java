...
public class FragmentUtils extends Fragment {
     ...
     */
    public static <T extends Fragment> void show(FragmentManager fragmentManager, int containerViewId, String tag, Class<T> tClass) {
        show(fragmentManager, containerViewId, tag, tClass, null, null);
    }

    /**
     * @see #show(FragmentManager, int, String, Class)
     */
    public static <T extends Fragment> void show(FragmentManager fragmentManager, int containerViewId, String tag, Class<T> tClass, Activity activity, String title) {
